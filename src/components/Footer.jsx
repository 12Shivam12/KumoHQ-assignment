...
const Footer = () => {
    return (
        <footer className="globalFooter__storefront layout--halfMargin backgroundParsnip fs-unmask" data-module-id="globalFooter" data-entry-id="3ifwtebV3iMWMUOWm4uUYefooter">
            <div className="related_links layout content content--8of8-medium content--12of16-large">
                <ul className="related_links__list flex flex--columns-2-medium flex--columns-4-large">
                    <li className="related_links__list__listItem">
                        <h3 className="footerItemColumn__heading related_links__list__listItem__item copy" data-context-text="Related links">
                            <p>Related Links:</p>
                        </h3>
                    </li>
                    <li className="related_links__list__listItem">
                        <div className="footerItem related_links__list__listItem__item" data-context-text="What is SEO?">
                            <a className="cta" href="https://mailchimp.com/marketing-glossary/seo/">What is SEO?</a>
                        </div>
                    </li>
                    <li className="related_links__list__listItem">
                        <div className="footerItem related_links__list__listItem__item" data-context-text="Make Money Online">
                            <a className="cta" href="https://mailchimp.com/resources/make-money-online/">Make Money Online</a>
                        </div>
                    </li>
                    <li className="related_links__list__listItem">
                        <div className="footerItem related_links__list__listItem__item" data-context-text="ChatGPT: What to Know About This AI Content Writing Tool">
                            <a className="cta" href="https://mailchimp.com/resources/chat-gpt-ai-content-writing/">ChatGPT: What to Know About This AI Content Writing Tool</a>
                        </div>
                    </li>
                </ul>
            </div>

            <hr className="margin--vertical-6" />

            <div className="layout content content--8of8-medium contentTop">
                <div className="contentBox--top">
                    <div className="footerItemColumn" data-context-text="Products">
                        <h3 className="footerItemColumn__heading copy margin--bottom-c6">Products</h3>
                        <ul>
                            <li className="footerItem">
                                <a className="cta" href="/why-mailchimp/">Why Mailchimp?</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/whats-new/">Product Updates</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/features/email/">Email Marketing</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/features/website-builder/">Websites</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/features/transactional-email/" aria-label="Transactional Email">Transactional Email</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/resources/mailchimp-comparisons/">How We Compare</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/gdpr/">GDPR Compliance</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/about/security/">Security</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="https://status.mailchimp.com/">Status</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/features/mailchimp-mobile/">Mobile App</a>
                            </li>
                        </ul>
                    </div>
                    <div className="footerItemColumn" data-context-text="Resources">
                        <h3 className="footerItemColumn__heading copy margin--bottom-c6">Resources</h3>
                        <ul>
                            <li className="footerItem">
                                <a className="cta" href="/resources/" aria-label="Marketing Library">Marketing Library</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/resources/free-marketing-features-overview/" aria-label="Free Marketing Tools">Free Marketing Tools</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/marketing-glossary/">Marketing Glossary</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/integrations/">Integrations Directory</a>
                            </li>
                        </ul>
                    </div>
                    <div className="footerItemColumn" data-context-text="Community">
                        <h3 className="footerItemColumn__heading copy margin--bottom-c6">Community</h3>
                        <ul>
                            <li className="footerItem">
                                <a className="cta" href="/andco/">Agencies &amp; Freelancers</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="https://mailchimp.com/developer/">Developers</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/events/" aria-label="Events">Events</a>
                            </li>
                        </ul>
                    </div>
                    <div className="footerItemColumn" data-context-text="Company">
                        <h3 className="footerItemColumn__heading copy margin--bottom-c6">Company</h3>
                        <ul>
                            <li className="footerItem">
                                <a className="cta" href="/about/">Our Story</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/newsroom/">Newsroom</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="https://mailchimp.com/givewhereyoulive" target="_blank" rel="noopener noreferrer" aria-label="Give Where You Live">Give Where You Live</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="/jobs/">Careers</a>
                            </li>
                            <li className="footerItem">
                                <a className="cta" href="https://www.intuit.com/accessibility/" target="_blank" rel="noopener noreferrer">Accessibility</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <li className="footerItem">
                                <div className="globalNav__brandMoment" data-context-text="Check it out">
                                    ...
                                    <p className="margin--top-c3">
                                        <a className="ctaArrow cta--small" href="https://mailchimp.com/presents/">Check it out
                                        </a>
                                    </p>
                                </div>
                            </li>
            ...
            <hr className="hr margin--vertical-3" />

            <div className="layout content contentBottom">
                <div className="flex flex--middle flex--center contentBox--bottom">
                    <ul className="coBrandedLinks" aria-label="Other Intuit Brands">
                        <li className="coBrandedLinks__intuit">
                            <a href="https://www.intuit.com/" aria-label="Intuit" target="_blank" rel="noopener noreferrer">
                        ...
                        <li className="coBrandedLinks__turbotax">
                            <a href="https://turbotax.intuit.com/" aria-label="Turbo Tax" target="_blank" rel="noopener noreferrer">
                        ...
                        <li className="coBrandedLinks__creditkarma">
                            <a href="https://www.creditkarma.com/" aria-label="Credit Karma" target="_blank" rel="noopener noreferrer">
                        ...
                        <li className="coBrandedLinks__quickbooks">
                            <a href="https://quickbooks.intuit.com/" aria-label="Quickbooks" target="_blank" rel="noopener noreferrer">
                    ...
                    <ul className="cell flex appStore flex--columns-2-medium flex--right">
                        <li className="cell globalFooter__item--app">
                            <a href="https://mailchimp.app.link/9v17ZhaeNR">
                                <img src="https://eep.io/images/yzco4xsimv0y/1u3hha7FE0Q402e2qsMu6a/5e403548149c1618b64034284f692ff1/icon-ios.svg?w=160&amp;q=70" srcSet="https://eep.io/images/yzco4xsimv0y/1u3hha7FE0Q402e2qsMu6a/5e403548149c1618b64034284f692ff1/icon-ios.svg?w=160&amp;q=70 160w, https://eep.io/images/yzco4xsimv0y/1u3hha7FE0Q402e2qsMu6a/5e403548149c1618b64034284f692ff1/icon-ios.svg?w=320&amp;q=70 320w" sizes="(min-width: 37.5em) 320px, 160px" loading="lazy" alt="[KB] Download on the App Store" width="135" height="40" />
                            </a>
                        </li>
                        <li className="cell globalFooter__item--app">
                            <a href="https://mailchimp.app.link/dxK9lDeHTR">
                                <img src="https://eep.io/images/yzco4xsimv0y/64EpnI4RsQI66c2y2O60G2/4c34d7bc4dd7a4362c7e19a06c109e21/icon-android.svg?w=160&amp;q=70" srcSet="https://eep.io/images/yzco4xsimv0y/64EpnI4RsQI66c2y2O60G2/4c34d7bc4dd7a4362c7e19a06c109e21/icon-android.svg?w=160&amp;q=70 160w, https://eep.io/images/yzco4xsimv0y/64EpnI4RsQI66c2y2O60G2/4c34d7bc4dd7a4362c7e19a06c109e21/icon-android.svg?w=320&amp;q=70 320w" sizes="(min-width: 37.5em) 320px, 160px" loading="lazy" alt="Get it on Google Play" width="135" height="40" />
                            </a>
                        </li>
                    </ul>
                    <ul className="cell socialMedia flex flex--center">
                        <li className="globalFooter__item--social">
                            <a href="https://www.facebook.com/mailchimp/" aria-label="Facebook"></a>
                        </li>
                        <li className="globalFooter__item--social">
                            <a href="https://twitter.com/Mailchimp" aria-label="Twitter"></a>
                        </li>
                        <li className="globalFooter__item--social">
                            <a href="https://www.instagram.com/mailchimp/" aria-label="Instagram"></a>
                        </li>
                        <li className="globalFooter__item--social">
                            <a href="https://www.linkedin.com/company/mailchimp" aria-label="LinkedIn"></a>
                        </li>
                        <li className="globalFooter__item--social">
                            <a href="https://www.youtube.com/user/Mailchimp" aria-label="YouTube"></a>
                        </li>
                    </ul>
                    ...
                    <div className="storefrontColophon flex globalFooter__colophon">
                        <div className="margin--bottom-c3">
                            <div className="margin--right-c3 margin--bottom-c3 screen-reader-only">
                                <label htmlFor="languagePicker-928800102" className="formLabel formLabel--select">This page is now available in other languages.</label>
                            </div>
                            <div className="formSelect formSelect--small-secondary">
                                <select name="languagePicker" id="languagePicker-928800102" data-behavior="languagePicker">
                                    <option value="/" data-locale="en" selected="selected">English</option>
                                    <option value="/es/" data-locale="es">Español</option>
                                    <option value="/fr/" data-locale="fr">Français</option>
                                    <option value="/pt-br/" data-locale="pt-br">Português</option>
                                    <option value="/de/" data-locale="de">Deutsch</option>
                                    <option value="/it/" data-locale="it">Italiano</option>
                                </select>
                            </div>
                        </div>
